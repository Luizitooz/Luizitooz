...
* **Linguagens:** SQL (MySQL, SQL Server) e Python.
* **Visualização de Dados:** Power BI e Excel Avançado.
* **Ferramentas de Negócio:** SAP, Métodos Ágeis (Scrum) e Modelagem de Dados (DER).
* **Automação:** Desenvolvimento de assistentes inteligentes e integrações via API.
